...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_CCU4" URI="http://resources/4.1.26/app/PWM_CCU4/0" description="PWM APP using one timer slice of CCU4, with external events support, to generate a PWM output." mode="NOTSHARABLE" version="4.1.26" minDaveVersion="4.3.2" instanceLabel="PWM_CCU4_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_cmp_match" URI="http://resources/4.1.26/app/PWM_CCU4/0/vs_ccu4_cc4_compare_match_interrupt" hwSignal="cmds_cmus" hwResource="//@hwResources.0" required="false"/>
  ...
  <hwResources name="PWM_CCU4 Channel Out" URI="http://resources/4.1.26/app/PWM_CCU4/0/__pin_hwres_port_channel_out" resourceGroupUri="devicepackage/0/94" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
